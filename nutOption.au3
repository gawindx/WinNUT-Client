...
$optionList = $optionList & "int InstantAction;int AllowGrace;"
$optionList = $optionList & "int ShutdownDelay;int GraceDelay;"
$optionList = $optionList & "int TypeOfStop;int frequencysupply"
...
Func Update_counter()
	If $Active_Countdown Then
		$In_progress -= 1
		Update_label($In_progress)
		If $In_progress = 0 Then AdlibUnregister("Update_counter")
	EndIf
